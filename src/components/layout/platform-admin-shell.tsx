...
export function PlatformAdminShell({
  ...
  return (
    ...
    >
      <div className="min-h-screen w-full bg-[linear-gradient(180deg,#f6f3ed_0%,#ece4d8_100%)]">
        <aside
          className={[
          ...
          style={{ backgroundColor: "#2b3a44", color: "#ffffff" }}
        >
          <div className="flex h-full flex-col">
            ...
            <form action={signOutAction} className="mt-4">
              <button className="flex w-full items-center gap-3 rounded-2xl border border-current/15 px-4 py-3 text-left font-semibold text-current transition hover:bg-current/10">
                <span className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-current/10 text-sm">
                  S
                </span>
