...
export const companySettingsSchema = z.object({
  ...
  button_background_color: colorHexSchema,
  button_text_color: colorHexSchema,
  tab_background_color: colorHexSchema,
  tab_text_color: colorHexSchema,
  tab_active_background_color: colorHexSchema,
  tab_active_text_color: colorHexSchema,
